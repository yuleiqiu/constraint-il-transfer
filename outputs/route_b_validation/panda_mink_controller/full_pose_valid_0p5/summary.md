...
Controller: `/home/yulei/codes/constraint-il-transfer/outputs/route_b_validation/panda_mink_controller/controller_configs/panda_mink_ik_ori_cost_0p5.json`
Split: `valid`
...
|---:|---:|---:|---:|---:|---:|---:|---:|
| 1.686 | 0.359 | 0.215 | 1.330 | 0.371 | 0.891 | 1.000 | 1.000 |
