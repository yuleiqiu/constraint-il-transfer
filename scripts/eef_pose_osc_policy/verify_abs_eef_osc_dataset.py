"""
Replay stored absolute-EEF OSC actions through the dataset's robomimic env.

This verifies that the generated dataset action key and env metadata are
jointly executable, without overriding controller settings at runtime.
